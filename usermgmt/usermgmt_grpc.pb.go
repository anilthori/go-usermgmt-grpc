...
func (c *userManagementClient) CreateNewUser(ctx context.Context, in *NewUserRequest, opts ...grpc.CallOption) (*NewUserResponse, error) {
...
func (c *userManagementClient) GetUser(ctx context.Context, in *UserDetailsRequest, opts ...grpc.CallOption) (*UserDetailsResponse, error) {
...
func (UnimplementedUserManagementServer) GetUser(context.Context, *UserDetailsRequest) (*UserDetailsResponse, error) {
...
func _UserManagement_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).GetUser(ctx, req.(*UserDetailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
